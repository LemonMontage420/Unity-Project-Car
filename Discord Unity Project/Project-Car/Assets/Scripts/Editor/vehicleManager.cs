...
public class vehicleManager : EditorWindow{
    ...
    void wheelsProperties(){
        ...
        frontOffset.z = EditorGUILayout.Slider(frontOffset.z,.6f, 2.2f);
        EditorGUILayout.EndHorizontal();
        ...
        frontOffset.x = EditorGUILayout.Slider(frontOffset.x,0.2f, 1);
        EditorGUILayout.EndHorizontal();
        ...
        rearOffset.z = EditorGUILayout.Slider(rearOffset.z,.6f, 2.2f);
        EditorGUILayout.EndHorizontal();
        ...
        rearOffset.x = EditorGUILayout.Slider(rearOffset.x,0.2f, 1);
        EditorGUILayout.EndHorizontal();
